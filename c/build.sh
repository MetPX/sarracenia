...
gcc -shared -Wl,-soname,libsrshim.so.1 -o libsrshim.so.1.0.0 sr_poc.o sr_context.o sr_config.o sr_credentials.o -ldl -Wl,-rpath,/home/peter/src/rabbitmq-c/build/librabbitmq -L/home/peter/src/rabbitmq-c/build/librabbitmq -lrabbitmq -luriparser -lc

gcc -o sr_configtest sr_configtest.c sr_config.o sr_credentials.o -luriparser
gcc -o sr_cpost sr_cpost.c sr_context.o sr_config.o sr_credentials.o -Wl,-rpath,${RABBIT_LIBDIR} -L${RABBIT_LIBDIR} -lrabbitmq -luriparser 
