...
gcc -fPIC -c -Wall sr_context.c 
gcc -shared -Wl,-soname,libsrshim.so.1 -o libsrshim.so.1.0.0 sr_poc.o sr_context.o sr_config.o sr_credentials.o -ldl -lrabbitmq -luriparser -lc
