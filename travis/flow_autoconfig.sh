...
sudo apt-get update
sudo apt -y install openssh-server rabbitmq-server erlang-nox metpx-sr3c librabbitmq4 metpx-libsr3c metpx-libsr3c-dev git python3-pip net-tools findutils
