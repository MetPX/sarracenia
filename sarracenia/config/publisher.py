...
already_a_list = hasattr(options, 'post_exchange') and isinstance(options.post_exchange,         already_a_list = hasattr(options, 'post_exchange') and)        # logger.debug( f" {exchange_root=}  {already_a_list=} " )
