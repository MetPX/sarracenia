...
class Geometry(FlowCB):
    ...
    def after_accept(self, worklist):
        ...
        for m in worklist.incoming:
            ...
            if 'geometry' not in m or self.geometry_geojson is None:
            ...
            try:
                ...
                # Ultimately, if it's not, some of the logic in following sections will
                # fail, and we'll have to catch those errors then
            ...
            try:
                ...
                # catch cases for when neither the config or the message have points or
                # poylgons (multipoint, line, etc..)
                else:
