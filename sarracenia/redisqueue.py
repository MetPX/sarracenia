...
class RedisQueue():
    ...
    * a dictionary indexed by some sort of key to prevent duplicate
    ...
    def __init__(self, options, name):
        ...
        # track last housekeeping to ensure that multiple instances don't try to
        # do it more often than the defined interval
    ...
    def on_housekeeping(self):
        ...
        try:
            ...
            while True:
                ...
                i = i + 1
                if not self._needs_requeuing(message):
                    continue
