...
Sarracenia imposes some conventions on queue names, and enforces permission models.
...
1. queue names start with q_<amqpUserName>_<whatever>
2. the owner/user of the queue's AMQP username 
...
4. xr_<amqpUserName> is the reporting exchange for a given user. It is only readable by that user.
...
For example, a user named Alice will have at least two exchanges:
