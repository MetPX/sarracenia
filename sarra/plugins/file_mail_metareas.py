...
class MetMailer(object):
	...
	def on_file(self, parent):
		...
		cmd = ("echo {1} > {0} ; echo {2} >> {0} ; echo {3} >> {0} ; echo >> {0} ; cat {4} >> {0}".
		...
		try:
			...
			if resp.returncode != 0 and len(resp.stderr) != 0:
				logger.error("file_mail_metareas: could not set username, password and bulletin \
		...
		if subp[0] == 'FQCN02' and subp[1] == 'CWAO' :  egc = "0,1,4,66n171w11057,1,0"
		if subp[0] == 'FICN02' and subp[1] == 'CWIS' :  egc = "0,1,4,66n171w11057,1,0"
		...
		if subp[0] == 'FZAK61' and subp[1] == 'PAFG' :  egc = "0,1,4,66n171w11034,1,0"
		if subp[0] == 'FZAK69' and subp[1] == 'PAFG' :  egc = "0,1,4,66n171w11034,1,0"
		...
		# Merged FQ CWAO product replaces the FW CWNT and FI CWIS  -  July 15, 2013
		if subp[0] == 'FQCN04' and subp[1] == 'CWAO' :  egc = "0,1,4,66n126w11078,1,0"
		if subp[0] == 'FICN04' and subp[1] == 'CWIS' :  egc = "0,1,4,66n126w11078,1,0"

		if subp[0] == 'FICN07' and subp[1] == 'CWIS' :  egc = "0,1,4,66n080w11032,1,0"
		...
		if subp[0] == 'FQCN05' and subp[1] == 'CWAO' :  egc = "0,1,4,50n098w18030,1,0"
		if subp[0] == 'FICN05' and subp[1] == 'CWIS' :  egc = "0,1,4,50n098w18030,1,0"
		...
		if subp[0] == 'FBDN51' and subp[1] == 'EKMI' :  egc = "0,1,4,66n080w11032,1,0"
