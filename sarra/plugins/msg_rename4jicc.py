...
"""
 ...
 and restructure it into an incoming pds  name : jicc.yyyymmddhhmm.ccstn.dat
                     2016-03-02 21:27:22,015 [INFO] 201 Downloaded : v02.log.20160302.MSC-CMC.METADATA.ccstn.dat:pull-ccstn:NCP:JICC:5:Codecon:20160302212706 20160302212715.58 http://ddi2.edm.ec.gc.ca/ 20160302/MSC-CMC/METADATA/ccstn.dat:pull-ccstn:NCP:JICC:5:Codecon:20160302212706 201 dms-op3-host3.edm.ec.gc.ca dms 6.955598 parts=1,55024600,1,0,0 sum=d,3da695f047174462ebe5d0352f4f8295 from_cluster=DDI.CMC source=metpx to_clusters=DDI.CMC,DDI.EDM rename=/apps/dms/dms-decoder-jicc/data/import/jicc.201603022127.ccstn.dat:pull-ccstn:NCP:JICC:5:Codecon:20160302212706 message=Downloaded 
...
class Renamer(object):
      ...
      def perform(self,parent):
          ...
          if not 'ccstn.dat' in parent.msg.local_file : return True

          # build new name
          local_file = parent.msg.local_file
          ...
          parent.msg.local_file        = local_file
