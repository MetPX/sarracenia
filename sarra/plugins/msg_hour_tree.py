...
class Renamer(object):
      ...
      def perform(self,parent):
          ...
          parent.local_dir += '/' + datestr    # append the hourly element to the directory tree.

          # insert the additional hourly directory into the path of the file to be written.
          new_fname = parent.msg.local_file.split('/')
          parent.msg.local_file = '/'.join(new_fname[0:-1]) + '/' + datestr + '/' + new_fname[-1] 
