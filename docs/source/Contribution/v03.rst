...
to navigating the source code of sr3, which has now stablizied enough that 
it substantially passes the flow_tests.
Sr3 is perhaps not really usable yet, but the direction is well established and further
...
this document will not help as it is exclusively about mapping v2 to sr3. 
...
implemented import-based and group oriented sr3 plugin framework. ( #213 )
